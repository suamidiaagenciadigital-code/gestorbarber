    ...
    <div className="min-h-screen bg-[#F7F3EC] font-inter">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="bg-white rounded-2xl border border-[#E8DED0] p-10">
          ...
          <h1 className="text-3xl font-black text-[#111111] mb-2 font-playfair">Termos de Uso</h1>
          ...
          <div className="bg-[#FFF4E0] border border-[#C89B3C]/30 rounded-xl p-5 text-sm text-[#92680C] leading-relaxed">
            <strong>Aviso:</strong> Este documento está em construção. O conteúdo completo dos Termos de Uso do Gestor Barber será publicado em breve. Entre em contato pelo e-mail{' '}
